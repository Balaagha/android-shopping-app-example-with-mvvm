 ...
 */
public class CoreBottomSheetDialog extends AppCompatDialog {
    ...
    public CoreBottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
    ...
    protected CoreBottomSheetDialog(
     ...
     * windowAnimation. Call xxx if you want to utilize the
